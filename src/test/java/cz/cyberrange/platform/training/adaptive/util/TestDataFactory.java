package cz.cyberrange.platform.training.adaptive.util;
...
import cz.cyberrange.platform.training.adaptive.api.dto.responses.SandboxPoolInfo;
...
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceCreateDTO;
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceDTO;
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceUpdateDTO;
...
//            6, Actions.RESUME);
    ...
    private UserRefDTO userRefDTO1 = generateUserRefDTO(10L, "Michael Bolt", "Bolt", "Michael", "mail1@test.cz", "https://oidc.provider.cz/oidc", null);
    private UserRefDTO userRefDTO2 = generateUserRefDTO(12L, "Peter Most", "Most", "Peter", "mail2@test.cz", "https://oidc.provider.cz/oidc", null);
