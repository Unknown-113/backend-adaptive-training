...
/**
 * DTO returned when a Deep Link URL is generated for terminal-based exam access.
 */
...
public class DeepLinkDTO {
    ...
    @ApiModelProperty(value = "Expiration timestamp of the session token (300 seconds from generation)", required = true)
